...
urlpatterns = [
    ...
    path('moduloAdmin/Libro/Modificar2', moduloAdmin_Libro_Modificar2),
    path('moduloAdmin/Libro/Modificar3', moduloAdmin_Libro_Modificar3),
    ...
    path('moduloAdmin/Libro/Eliminar2', moduloAdmin_Libro_Eliminar2),
    path('moduloAdmin/Libro/Eliminar3', moduloAdmin_Libro_Eliminar3),
    ...
    path('moduloUsuario/Perfil/Eliminar', moduloUsuario_Perfil_Eliminar),
